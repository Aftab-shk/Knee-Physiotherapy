...
(function (global) {
  ...
  var CSS = [
    ...
    'background:rgba(255,255,255,.9);border:1px solid var(--border,#dadee1);',
    'color:var(--navy,#132733);letter-spacing:.02em;}',
    '.pxa-badge.warn{color:var(--pxa-warn);border-color:rgba(217,119,6,.45);}',
    '.pxa-badge.danger{color:var(--red,#dc2626);border-color:rgba(220,38,38,.45);}',
    ...
    '.pxa-cap span{background:rgba(255,255,255,.88);padding:3px 8px;border-radius:5px;',
